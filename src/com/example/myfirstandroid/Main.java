...
public class Main extends TabActivity
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		intentBlog = new Intent(this, WordView.class);
		intentNews = new Intent(this, GrammarView.class);
		intentRss = new Intent(this, SentenceTranslateView.class);
		intentSearch = new Intent(this, ArticleVew.class);
